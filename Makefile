...
# # Linux
 ...
 DDG_OPENGL_LIBS       = -lglut -lGL -lGLEW -lglut -lGLU -lX11
...
CC = g++
LD = g++
CFLAGS = -g -O3 -Wall -Werror -ansi -pedantic  $(DDG_INCLUDE_PATH) -I./include -I./src
LFLAGS = -g -O3 -Wall -Werror -ansi -pedantic $(DDG_LIBRARY_PATH)
